# Hosted Site - [Click this](https://shriyansh10.github.io/Mintlify/) to view the site

# Mintlify Landing Page Clone

A responsive recreation of the [Mintlify](https://mintlify.com) landing page, built to demonstrate precision in frontend development and UI design.

## 🔗 Live Demo

Check out the live version of the project here:
**[View Live Demo](https://shriyansh10.github.io/Mintlify/)**
...
This project is a complete recreation of the **Mintlify** landing page. The goal was to replicate the original site's design, layout, and animations to understand its structure and aesthetic choices.
...
📝 Credits
Original Design: Mintlify

Developed by: Shriyansh Agarwal
